...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.quiz_text = self.canvas.create_text(150, 125, width=280, text="question", fill="black", font=FONT)
    ...
    def true_pressed(self):
        self.give_feedback(self.quiz.check_answer(answer="True"))

    def false_pressed(self):
        self.give_feedback(self.quiz.check_answer(answer="False"))
